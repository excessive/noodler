...
local function cc(c)
	if select(3, love.window.getMode()).srgb then
		return {love.math.gammaToLinear(c)}
	end
	return c
end
...
-- frame
skin.controls.frame_body_color                      = cc {232, 232, 232, 255}
skin.controls.frame_name_color                      = cc {255, 255, 255, 255}
skin.controls.frame_name_font                       = smallfont

-- button
skin.controls.button_text_down_color                = cc {255, 255, 255, 255}
skin.controls.button_text_nohover_color             = cc {0, 0, 0, 200}
skin.controls.button_text_hover_color               = cc {255, 255, 255, 255}
skin.controls.button_text_nonclickable_color        = cc {0, 0, 0, 100}
skin.controls.button_text_font                      = smallfont

-- imagebutton
skin.controls.imagebutton_text_down_color           = cc {255, 255, 255, 255}
skin.controls.imagebutton_text_nohover_color        = cc {255, 255, 255, 200}
skin.controls.imagebutton_text_hover_color          = cc {255, 255, 255, 255}
skin.controls.imagebutton_text_font                 = imagebuttonfont

-- closebutton
skin.controls.closebutton_body_down_color           = cc {255, 255, 255, 255}
skin.controls.closebutton_body_nohover_color        = cc {255, 255, 255, 255}
skin.controls.closebutton_body_hover_color          = cc {255, 255, 255, 255}

-- progressbar
skin.controls.progressbar_body_color                = cc {255, 255, 255, 255}
skin.controls.progressbar_text_color                = cc {0, 0, 0, 255}
skin.controls.progressbar_text_font                 = smallfont

-- list
skin.controls.list_body_color                       = cc {232, 232, 232, 255}

-- scrollarea
skin.controls.scrollarea_body_color                 = cc {220, 220, 220, 255}

-- scrollbody
skin.controls.scrollbody_body_color                 = cc {0, 0, 0, 0}

-- panel
skin.controls.panel_body_color                      = cc {232, 232, 232, 255}

-- tabpanel
skin.controls.tabpanel_body_color                   = cc {232, 232, 232, 255}

-- tabbutton
skin.controls.tab_text_nohover_color                = cc {0, 0, 0, 200}
skin.controls.tab_text_hover_color                  = cc {255, 255, 255, 255}
skin.controls.tab_text_font                         = smallfont

-- multichoice
skin.controls.multichoice_body_color                = cc {240, 240, 240, 255}
skin.controls.multichoice_text_color                = cc {0, 0, 0, 255}
skin.controls.multichoice_text_font                 = smallfont

-- multichoicelist
skin.controls.multichoicelist_body_color            = cc {240, 240, 240, 200}

-- multichoicerow
skin.controls.multichoicerow_body_nohover_color     = cc {240, 240, 240, 255}
skin.controls.multichoicerow_body_hover_color       = cc {51, 204, 255, 255}
skin.controls.multichoicerow_text_nohover_color     = cc {0, 0, 0, 150}
skin.controls.multichoicerow_text_hover_color       = cc {255, 255, 255, 255}
skin.controls.multichoicerow_text_font              = smallfont

-- tooltip
skin.controls.tooltip_body_color                    = cc {255, 255, 255, 255}

-- textinput
skin.controls.textinput_body_color                  = cc {250, 250, 250, 255}
skin.controls.textinput_indicator_color             = cc {0, 0, 0, 255}
skin.controls.textinput_text_normal_color           = cc {0, 0, 0, 255}
skin.controls.textinput_text_placeholder_color      = cc {127, 127, 127, 255}
skin.controls.textinput_text_selected_color         = cc {255, 255, 255, 255}
skin.controls.textinput_highlight_bar_color         = cc {51, 204, 255, 255}

-- slider
skin.controls.slider_bar_outline_color              = cc {220, 220, 220, 255}

-- checkbox
skin.controls.checkbox_body_color                   = cc {255, 255, 255, 255}
skin.controls.checkbox_check_color                  = cc {128, 204, 255, 255}
skin.controls.checkbox_text_font                    = smallfont

-- radiobutton
skin.controls.radiobutton_body_color                = cc {255, 255, 255, 255}
skin.controls.radiobutton_check_color               = cc {128, 204, 255, 255}
skin.controls.radiobutton_inner_border_color        = cc {77, 184, 255, 255}
skin.controls.radiobutton_text_font                 = smallfont

-- collapsiblecategory
skin.controls.collapsiblecategory_text_color        = cc {255, 255, 255, 255}

-- columnlist
skin.controls.columnlist_body_color                 = cc {232, 232, 232, 255}

-- columlistarea
skin.controls.columnlistarea_body_color             = cc {232, 232, 232, 255}

-- columnlistheader
skin.controls.columnlistheader_text_down_color      = cc {255, 255, 255, 255}
skin.controls.columnlistheader_text_nohover_color   = cc {0, 0, 0, 200}
skin.controls.columnlistheader_text_hover_color     = cc {255, 255, 255, 255}
skin.controls.columnlistheader_text_font            = smallfont

-- columnlistrow
skin.controls.columnlistrow_body1_color             = cc {245, 245, 245, 255}
skin.controls.columnlistrow_body2_color             = cc {255, 255, 255, 255}
skin.controls.columnlistrow_body_selected_color     = cc {26, 198, 255, 255}
skin.controls.columnlistrow_body_hover_color        = cc {102, 217, 255, 255}
skin.controls.columnlistrow_text_color              = cc {100, 100, 100, 255}
skin.controls.columnlistrow_text_hover_color        = cc {255, 255, 255, 255}
skin.controls.columnlistrow_text_selected_color     = cc {255, 255, 255, 255}

-- modalbackground
skin.controls.modalbackground_body_color            = cc {255, 255, 255, 100}

-- linenumberspanel
skin.controls.linenumberspanel_text_color           = cc {170, 170, 170, 255}
skin.controls.linenumberspanel_body_color			= cc {235, 235, 235, 255}

-- grid
skin.controls.grid_body_color                       = cc {230, 230, 230, 255}

-- form
skin.controls.form_text_color                       = cc {0, 0, 0, 255}
skin.controls.form_text_font                        = smallfont

-- menu
skin.controls.menu_body_color                       = cc {255, 255, 255, 255}

-- menuoption
skin.controls.menuoption_body_hover_color           = cc {51, 204, 255, 255}
skin.controls.menuoption_text_hover_color           = cc {255, 255, 255, 255}
skin.controls.menuoption_text_color                 = cc {180, 180, 180, 255}
